...
const App = () => {
  ...
  const title = 'Bat-Man';
  const description = 'A symbol of justice forged in the shadows, Batman is not just a man—he is a myth...';

  const image2 = '/images/Batman 2.jpeg';
  const title2 = 'Bat-Man';
  const description2 = 'Cloaked in darkness, driven by a past scarred with tragedy, he stands as Gotham’s last line of defense...';
